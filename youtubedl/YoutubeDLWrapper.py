...
import datetime
import xbmc
from youtubedl.yd_private_libs import util, updater
from youtubedl import YDStreamUtils as StreamUtils

updater.updateCore()

updater.set_youtube_dl_importPath()

from youtubedl.utils import std_headers, DownloadError  # noqa E402
...
try:
    ...
    from youtubedl.yd_private_libs import _subprocess
...
coreVersion = youtubedl.version.__version__
updater.saveVersion(coreVersion)
util.LOG('youtubedl core version: {0}'.format(coreVersion))
...
class YoutubeDLWrapper(youtubedl.YoutubeDL):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        youtubedl.YoutubeDL.__init__(self, *args, **kwargs)
    ...
    def add_info_extractor(self, ie):
        ...
        ########################################################################
        youtubedl.YoutubeDL.add_info_extractor(self, ie)
...
def _getYTDL():
    ...
    if _YTDL:
        return _YTDL
    if False: #util.DEBUG and util.getSetting('ytdl_debug', False):
...
def download(info):
    from youtubedl import downloader
    ytdl = _getYTDL()
